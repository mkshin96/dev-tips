...
public class Runner extends BaseRunner {
    ...
    public Collection<RunResult> run() throws RunnerException {
        out.println("*** WARNING: ***************************************************************************");
        out.println("*** WARNING: *** You are running the binary built from the old Mercurial repository. ***");
        out.println("*** WARNING: *** This repository is no longer supported. Please make sure you build  ***");
        out.println("*** WARNING: *** from Git repositories: https://github.com/openjdk/jmh               ***");
        out.println("*** WARNING: ***************************************************************************");
